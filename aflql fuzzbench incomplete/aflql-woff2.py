...
def build():
        ...
        command = [
           'python3',
           '/out/new/woff2/litan.py',
           '/out/new/woff2/dict',
           '/out/new/woff2/litout.log'
        ]      
        worker1 = subprocess.Popen(command)
        print(worker1.communicate())
        command1 = [
           'python3',
           '/out/new/woff2/stan.py',
           '/out/new/woff2/dict1',
           '/out/new/woff2/outstr.log'
        ]
        worker2 = subprocess.Popen(command1)
        print(worker2.communicate())
        
        subprocess.call(["cp /out/new/woff2/dict1/* /out/new/woff2/dict/."],shell=True)
        print('done!')
        subprocess.call(["cp -r /out/new/woff2/dict/ /out/new/dict/"],shell=True)
        print('done!!')        
