...
def build():
        ...
        command = [
           'python3',
           '/out/new/bloaty/litan.py',
           '/out/new/bloaty/dict',
           '/out/new/bloaty/litout.log'
        ]      
        worker1 = subprocess.Popen(command)
        print(worker1.communicate())
        command1 = [
           'python3',
           '/out/new/bloaty/stan.py',
           '/out/new/bloaty/dict1',
           '/out/new/bloaty/outstr.log'
        ]
        ...
        subprocess.call(["cp /out/new/bloaty/dict1/* /out/new/bloaty/dict/."],shell=True)
        print('done!')
        subprocess.call(["cp -r /out/new/bloaty/dict/ /out/new/dict/"],shell=True)
        print('done!!')        
