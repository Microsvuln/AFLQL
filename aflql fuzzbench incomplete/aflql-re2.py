...
def build():
        ...
        command = [
           'python3',
           '/out/new/re2/litan.py',
           '/out/new/re2/dict',
           '/out/new/re2/litout.log'
        ]      
        ...
        command1 = [
           ...
           '/out/new/re2/stan.py',
           '/out/new/re2/dict1',
           '/out/new/re2/outstr.log'
        ]
        worker2 = subprocess.Popen(command1)
        print(worker2.communicate())
        
        subprocess.call(["cp /out/new/re2/dict1/* /out/new/re2/dict/."],shell=True)
        print('done!')
        subprocess.call(["cp -r /out/new/re2/dict/ /out/new/dict/"],shell=True)
        print('done!!')        
