...
def build():
        ...
        command = [
           'python3',
           '/out/new/PROJ/litan.py',
           '/out/new/PROJ/dict',
           '/out/new/PROJ/litout.log'
        ]      
        worker1 = subprocess.Popen(command)
        print(worker1.communicate())
        command1 = [
           'python3',
           '/out/new/PROJ/stan.py',
           '/out/new/PROJ/dict1',
           '/out/new/PROJ/outstr.log'
        ]
        worker2 = subprocess.Popen(command1)
        print(worker2.communicate())
        
        subprocess.call(["cp /out/new/PROJ/dict1/* /out/new/PROJ/dict/."],shell=True)
        print('done!')
        subprocess.call(["cp -r /out/new/PROJ/dict/ /out/new/dict/"],shell=True)
        print('done!!')        
