...
def build():
        ...
        command = [
           'python3',
           '/out/new/curl/litan.py',
           '/out/new/curl/dict',
           '/out/new/curl/litout.log'
        ]      
        worker1 = subprocess.Popen(command)
        print(worker1.communicate())
        command1 = [
           'python3',
           '/out/new/curl/stan.py',
           '/out/new/curl/dict1',
           '/out/new/curl/outstr.log'
        ]
        ...
        subprocess.call(["cp /out/new/curl/dict1/* /out/new/curl/dict/."],shell=True)
        print('done!')
        subprocess.call(["cp -r /out/new/curl/dict/ /out/new/dict/"],shell=True)
        print('done!!')        
