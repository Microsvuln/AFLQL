            ...
            if i != 0:
                ...
                if (str1 != '0') and (str1 != 'ffffffff') and (str1 != 'fffffffe') or (len(str1) == 4) or (len(str1) == 8):
                    ...
                    try:
                            ...
                            with open(corpdir+'/lit-array-seed{0}'.format(n), 'w') as file:                    
                                    str1 = str1.replace("0x","");
                                    print (str1)                                    
                                    str1 = int(str1,base=16)                                    
                                    str1 = str1.to_bytes(4, byteorder='little')
                                    print("final1 : " + str(str1))                                    
                                    print ("I write : "+ str(str1))                            
                                    file.write(str(str1))                                    
                                    file.close()
                                    with open (corpdir+'/lit-array-seed{0}'.format(n), 'r') as q :
                                        a = q.readline()
                                        print("I read : " + str(a))
                                        a = a[1:]
                                        print ("Go to write this :" + str(a))
                                        q.close()
                                        with open (corpdir+'/lit-array-seed{0}'.format(n), 'w') as w1 :
                                                w1.write(str(a))
                                                print ("Done!")
                                                w1.close()                                                                                
                    except:                                 
